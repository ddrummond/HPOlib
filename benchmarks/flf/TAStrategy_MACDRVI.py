...
def myAlgo(params, **kwargs):
    ...
    maxRVISellThreshold = int(params.get("maxRVISellThreshold", "50"))
    minRVIEnterLongSignal = int(params.get("minRVIEnterLongSignal", "60"))
    maxRVIEnterShortSignal = int(params.get("maxRVIEnterShortSignal", "40"))
    minRVIExitLongThreshold = int(params.get("minRVIExitLongThreshold", "40"))
    maxRVIExitShortThreshold = int(params.get("maxRVIExitShortThreshold", "60"))
    ...
    cmd = r'python3 -u {:s}/tutorials/src/flf/StrategyRunner.py --writeOutputToFiles=False --inputGlobPath=tests/testData/features_reinfocement_training_*.csv --evalMethod=TA_ManyTraining --taStrategy=120 --bbPriceType={:d} --macdSlowPeriodFraction={:0.2f} --macdFastPeriodFraction={:0.2f} --signalperiod={:d} --stdevLookBackPeriods={:d} --stdevSmoothingPeriods={:d} --minRVIBuyThreshold={:d} --maxRVISellThreshold={:d} --minRVIEnterLongSignal={:d} --maxRVIEnterShortSignal={:d} --minRVIExitLongThreshold={:d} --maxRVIExitShortThreshold={:d}'\
        .format(experimentHome, bbPriceType, macdSlowPeriodFraction, macdFastPeriodFraction, signalperiod,
                ...
                minRVIBuyThreshold,
                maxRVISellThreshold,
                minRVIEnterLongSignal,
                maxRVIEnterShortSignal,
                minRVIExitLongThreshold,
                maxRVIExitShortThreshold)
